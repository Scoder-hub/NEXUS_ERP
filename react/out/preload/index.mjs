...
const api = {
  invoke: (channel, args) => {
    const allowedChannels = [
      ...
      "settings:get-by-key",
      "settings:update",
      "purchase:list-orders",
      "purchase:get-order",
      "purchase:create-order",
      "purchase:update-order",
      "purchase:approve-order",
      "purchase:confirm-arrival",
      "purchase:list-suppliers",
      "purchase:get-supplier",
      "purchase:create-supplier",
      ...
      "inventory:stock-in",
      "inventory:stock-out",
      "inventory:list-warehouses",
      "production:list-work-orders",
      "production:get-work-order",
      "production:create-work-order",
      "production:update-work-order",
      "production:list-work-stations",
      "production:list-process-cards",
      "production:submit-report",
      "production:list-reports",
